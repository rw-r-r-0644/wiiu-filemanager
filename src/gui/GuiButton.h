...
class GuiButton : public GuiElement
{
	public:
		...
		//!Sets the min time in ms to consider a longPress
		//!\param ms Time in milliseconds
		void setHoldLimit(u64 ms);
		//!Sets rumble lenght in seconds (max 1 sec)
		//!\param len Time in seconds
		void setRumble(f32 len);
		...
		sigslot::signal3<GuiButton *, const GuiController *, GuiTrigger *> pressed;
		sigslot::signal3<GuiButton *, const GuiController *, GuiTrigger *> pressedLong;
