...
GuiSelectBox::GuiSelectBox(std::string caption,GuiFrame *parent)
 ...
 ,buttonClickSound(Resources::GetSound("settings_click_2.mp3"))
 {
    ...
    topValueButton.pressed.connect(this, &GuiSelectBox::OnTopValueClicked);
    ...
    DPADButtons.pressed.connect(this, &GuiSelectBox::OnDPADClick);
...
void GuiSelectBox::Init(std::map<std::string,std::string> values, int valueID)
{
    ...
    for(itr = values.begin(); itr != values.end(); itr++) {
        ...
        valueButtons[i].valueButton->pressed.connect(this,&GuiSelectBox::OnValueClicked);
